            ...
            <div className="riskPageWrapper navPage">
                <div>
                    ...
                    <div className="risk1PageImagesWrapper">
                        <div className="riskImageWrapper"><img src="http://localhost:5000/images/app-images/riskImage1.jpg" alt="img" /></div>
                        <div className="riskImageWrapper"><img src="http://localhost:5000/images/app-images/riskImage2.png" alt="img" /></div>
                        <div className="riskImageWrapper"><img src="http://localhost:5000/images/app-images/riskImage3.avif" alt="img" /></div>
                    </div>
                ...
                <div>
                    ...
                    <div className="risk2PageImagesWrapper">
                        <div className="riskImageWrapper"><img src="http://localhost:5000/images/app-images/riskImage4.jpg" alt="img" /></div>
                        <div className="riskImageWrapper"><img src="http://localhost:5000/images/app-images/riskImage5.jpg" alt="img" /></div>
                        <div className="riskImageWrapper"><img src="http://localhost:5000/images/app-images/riskImage6.jpg" alt="img" /></div>
                    </div>
